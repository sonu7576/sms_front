...
import { editStudent, getStudents, newStudent } from '../service/allApi';
...
function Edit () {
    ...
    useEffect(()=>{
        const student= async()=>{
            ...
            let exstingStudent = data.find(student => student._id === id)

            console.log(exstingStudent);
            



            setName(exstingStudent.name)
            setEmail(exstingStudent.email)
            setPhone(exstingStudent.phone)
            setPlace(exstingStudent.place)
            setAddress(exstingStudent.address)
            setDepartment(exstingStudent.department)
    ...
    const handleSubmit = async (e) => {
        ...
        if (validate()) {
            ...
            try {
                ...
                // API call
                const response = await editStudent(id,data)
